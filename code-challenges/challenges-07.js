...
const objLat = (obj) => {
    ...
    var LN = obj.lastName;
    var firstLetterofFirstName = FN.slice(0, 1);
    var firstLetterofLastName = LN.slice(0, 1);
    var TheRemainofFirstname = FN.substr(1);
    var TheRemainofLastname = LN.substr(1);
    var firstLetterofFirstNameCapital = firstLetterofFirstName.toLocaleUpperCase();
    var firstLetterofLastNameCapital = firstLetterofLastName.toLocaleUpperCase(); 

    var message ;
    message = `my name is ${firstLetterofFirstNameCapital}${TheRemainofFirstname} ${firstLetterofLastNameCapital}${TheRemainofLastname} I am ${obj.age} YO, and I love ${obj.hobby}.` ;
